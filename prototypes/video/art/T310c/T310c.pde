...
float lim1t = 20; // seuil de luminosité à partir duquel image restranscrite
float unlim1ted =  100; // seuil de luminosité jusqu'auquel image restranscrite
float frameIndex = 0;
float startAt = 0;
float endAt; 
float last;
